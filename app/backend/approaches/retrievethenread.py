...
"""
    ...
    def __init__(self, search_client: SearchClient, openai_deployment: str, chatgpt_model: str, embedding_deployment: str,
    ...
    def run(self, q: str, overrides: dict[str, Any], filters: dict) -> any:
