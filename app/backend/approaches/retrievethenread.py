...
class RetrieveThenReadApproach(Approach):
    ...
    system_chat_template = (
        "You are Timoo, our technical virtual assistant for time, attendance and activity management software. Your role is to provide detailed information and technical solutions regarding OCTIME product. "
