...
heMalePatientFemaleBot = {
    ...
    "exitAfterAverageImprovement": exit_after_average_improvement(is_patient_male=True, is_bot_male=False),
    ...
    "exitAfterAverageImprovementAndFailToConnectToCurrent": exit_after_average_improvement_and_fail_to_connect_to_current(is_patient_male=True, is_bot_male=False),
    "exitAfterAverageImprovementAndSucceedToConnectToCurrent": exit_after_average_improvement_and_succeed_to_connect_to_current(is_patient_male=True, is_bot_male=False),
