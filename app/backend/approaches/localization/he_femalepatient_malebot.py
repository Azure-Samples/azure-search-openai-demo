...
heFemalePatientMaleBot = {
    ...
    "exitAfterAverageImprovement": exit_after_average_improvement(is_patient_male=False, is_bot_male=True),
    ...
    "exitAfterAverageImprovementAndFailToConnectToCurrent": exit_after_average_improvement_and_fail_to_connect_to_current(is_patient_male=False, is_bot_male=True),
    "exitAfterAverageImprovementAndSucceedToConnectToCurrent": exit_after_average_improvement_and_succeed_to_connect_to_current(is_patient_male=False, is_bot_male=True),
