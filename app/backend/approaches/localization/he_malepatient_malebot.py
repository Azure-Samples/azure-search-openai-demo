...
heMalePatientMaleBot = {
    ...
    "videoUrl": lambda request_context: get_video_message(request_context, is_patient_male=True, is_bot_male=True),
    ...
    "exitAfterAverageImprovement": exit_after_average_improvement(is_patient_male=True, is_bot_male=True),
    ...
    "exitAfterAverageImprovementAndFailToConnectToCurrent": exit_after_average_improvement_and_fail_to_connect_to_current(is_patient_male=True, is_bot_male=True),
    "exitAfterAverageImprovementAndSucceedToConnectToCurrent": exit_after_average_improvement_and_succeed_to_connect_to_current(is_patient_male=True, is_bot_male=True),
