...
class ChatReadRetrieveReadApproach(Approach):
    ...
    def run(self, history: Sequence[dict[str, str]], overrides: dict[str, Any]) -> Any:
        ...
        if prompt_override is None:
            prompt = PROMPT_PREFIX.format(injected_prompt="", sources=content, chat_history=self.get_chat_history_as_text(history), follow_up_questions_prompt=follow_up_questions_prompt)
