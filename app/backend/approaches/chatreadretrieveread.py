...
"""
    ...
    def __init__(self, search_client: SearchClient, openai_type: str, chatgpt_deployment: str, chatgpt_model: str, embedding_deployment: str, embedding_model: str, sourcepage_field: str, content_field: str):
