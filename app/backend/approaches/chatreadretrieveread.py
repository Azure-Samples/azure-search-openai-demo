...
If you cannot generate a search query, return just the number 0.
    ...
    query_prompt_few_shots = [
        {'role' : USER, 'content' : 'What are my health insurance benefits?' },
        {'role' : ASSISTANT, 'content' : 'Show available health insurance benefits' },
        {'role' : USER, 'content' : 'Does my insurance cover sinus treatments?' },
        {'role' : ASSISTANT, 'content' : 'Health insurance sinus treatment' }
    ]
