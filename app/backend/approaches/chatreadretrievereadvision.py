...
class ChatReadRetrieveReadVisionApproach(ChatApproach):
    ...
    def system_message_chat_conversation(self):
        return """
        You are an intelligent assistant helping economists review documents produced in a litigation and identify key information in them, The documents contain text, graphs, tables and images.
