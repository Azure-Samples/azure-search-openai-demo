...
Thought: {agent_scratchpad}"""    
    ...
    CognitiveSearchToolDescription = "useful for searching the Microsoft resouces for SAP on Azure documenation related to deployment, migration and operations etc."
