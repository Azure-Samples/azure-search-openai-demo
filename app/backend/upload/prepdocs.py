...
from upload.prepdocslib.blobmanager import BlobManager
from upload.prepdocslib.embeddings import (
    AzureOpenAIEmbeddingService,
    ImageEmbeddings,
    OpenAIEmbeddings,
    OpenAIEmbeddingService,
)
from upload.prepdocslib.fileprocessor import FileProcessor
from upload.prepdocslib.filestrategy import FileStrategy
from upload.prepdocslib.integratedvectorizerstrategy import (
    IntegratedVectorizerStrategy,
)
from upload.prepdocslib.jsonparser import JsonParser
from upload.prepdocslib.listfilestrategy import (
    ADLSGen2ListFileStrategy,
    ListFileStrategy,
    LocalListFileStrategy,
)
from upload.prepdocslib.parser import Parser
from upload.prepdocslib.pdfparser import DocumentAnalysisParser, LocalPdfParser
from upload.prepdocslib.strategy import DocumentAction, SearchInfo, Strategy
from upload.prepdocslib.textsplitter import SentenceTextSplitter, SimpleTextSplitter
...
async def get_vision_key(credential: AsyncTokenCredential, args: Any) -> Optional[str]:
    if args.visionkey:
...
async def setup_file_strategy(credential: AsyncTokenCredential, args: Any) -> Strategy:
    ...
    if args.searchimages:
        key = await get_vision_key(credential, args)
        image_embeddings = (
