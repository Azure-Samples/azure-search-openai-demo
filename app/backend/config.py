...
CONFIG_AGENT_CLIENT_WITH_WEB = "agent_client_with_web"
CONFIG_AGENT_CLIENT_WITH_SHAREPOINT = "agent_client_with_sharepoint"
CONFIG_AGENT_CLIENT_WITH_WEB_AND_SHAREPOINT = "agent_client_with_web_and_sharepoint"
