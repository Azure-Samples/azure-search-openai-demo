                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <img src={logo} alt="Your Logo" className={`${styles.logo} ${styles.rounded}`} />
                            <h1 className={styles.chatEmptyStateTitle}>Chatea con Supercalifragilístico</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Pregunta lo que quieras o prueba con un ejemplo</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Escribe aquí una pregunta (e.g. ¿Quién es Batman?)"
                            disabled={isLoading}
