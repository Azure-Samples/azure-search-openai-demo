"""
Text embedding generation using OpenAI models.

This module provides the OpenAIEmbeddings class for generating text embeddings
using OpenAI or Azure OpenAI embedding models.
"""
...
class OpenAIEmbeddings(ABC):
    ...
    Attributes:
        open_ai_client: The OpenAI async client
        open_ai_model_name: Name of the embedding model
        open_ai_dimensions: Embedding vector dimensions
        disable_batch: Whether to disable batch processing
        azure_deployment_name: Azure OpenAI deployment name (if using Azure)
    ...
    def split_text_into_batches(self, texts: list[str]) -> list[EmbeddingBatch]:
        ...
        Raises:
            NotImplementedError: If the model doesn't support batch operations
        """
