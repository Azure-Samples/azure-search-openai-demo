...
class CsvParser(Parser):
    ...
    Each row becomes a Page object.
    """

    async def parse(self, content: IO) -> AsyncGenerator[Page, None]:
        """Parse CSV content into Page objects.

        Args:
            content: File-like object containing CSV data

        Yields:
            Page objects, one per row (excluding header)
        """
