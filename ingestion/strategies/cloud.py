"""
Cloud ingestion strategy using Azure Functions custom skills.

This strategy uses Azure Functions as custom skills in an Azure AI Search
skillset to process documents in the cloud.
"""
...
class CloudIngestionStrategy(Strategy):
    ...
    This strategy creates a skillset with custom Web API skills that call
    Azure Functions for document extraction, figure processing, and text processing.
    ...
    Attributes:
        ...
        document_extractor_uri: URI of the document extractor function
        figure_processor_uri: URI of the figure processor function
        text_processor_uri: URI of the text processor function
    """
    ...
    def _build_skillset(self) -> SearchIndexerSkillset:
        """Build the skillset with all custom skills."""
        prefix = f"{self.search_info.index_name}-cloud"
    ...
    async def setup(self) -> None:
        """Set up the search index, data source, skillset, and indexer."""
    ...
    async def run(self) -> None:
        """Execute the cloud ingestion strategy."""
