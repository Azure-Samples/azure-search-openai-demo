...
if __name__ == "__main__":
    ...
    parser.add_argument("--acl-action", required=False, choices=["remove", "add", "remove_all"], help="Optional. Whether to remove or add the ACL to the document")
    ...
    if args.enable_acls:
        ...
        if args.acl_type in ["remove", "add"] and args.acl is None:
