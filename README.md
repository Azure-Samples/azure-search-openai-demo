...
on linux OS:
- update `azure.yaml` file as required (see comments) and run "azd up"
...
on linux OS:
* Run `./app/start.sh` or update `.vscode/tasks.json` (see comments) file and run the "VS Code Task: Start App" to start the project locally.
