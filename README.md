...
- [Python 3+](https://www.python.org/downloads/)
    ...
    - **Important**: Please note that `azd up` would look for py launcher, make sure py launcher is the environment path. After successful installation of Python (with py launcher selected in the installer), put the location (i.e., C:\Windows) in the system path environment variable.
