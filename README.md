...
1. Run `azd login` 
   1. If you're in multi-tenant organization, please use `azd login --tenant-id {YOUR_TENANT_ID}`
   1. If you're using the VS Code DevContainer or GitHub Codespaces, please use `azd login --tenant-id {YOUR_TENANT_ID} --use-device-code`
